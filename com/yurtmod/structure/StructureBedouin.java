...
public class StructureBedouin 
{
	...
	{
		boolean flag = generateSmall(worldIn, doorBase, StructureHelper.STRUCTURE_DIR, Content.bedDoorSmall, Content.bedWall, Content.bedRoof);
	...
	{
		return generateSmall(worldIn, doorBase, dirForward, door, Content.bedWallFrame, Content.bedRoofFrame);
	}
	...
	{
		boolean flag = generateMedium(worldIn, doorBase, StructureHelper.STRUCTURE_DIR, Content.bedDoorMed, Content.bedWall, Content.bedRoof);
	...
	{
		boolean flag = generateLarge(worldIn, doorBase, StructureHelper.STRUCTURE_DIR, Content.bedDoorLarge, Content.bedWall, Content.bedRoof);
