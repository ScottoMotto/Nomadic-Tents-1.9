...
public class ItemTent extends Item 
{
	...
	public EnumActionResult onItemUse(ItemStack stack, EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		if(!TentDimension.isTentDimension(worldIn) && !worldIn.isRemote)
		{
			...
			{
				player.addChatMessage(new TextComponentTranslation(TextFormatting.RED + I18n.translateToLocal("chat.no_structure_ln1")));
				player.addChatMessage(new TextComponentTranslation(TextFormatting.RED + I18n.translateToLocal("chat.no_structure_ln2")));
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List par3List, boolean par4)
	{
		...
		par3List.add(color + I18n.translateToLocal("tooltip.extra_dimensional_space"));
	}
